...
| 别名 | 本机绝对路径 | 用途 |
|---|---|---|
| `ROOT` | `<home>/Documents/ChatGPT/GOAI` | 全部工作资料 |
| `APP` | `<home>/Documents/ChatGPT/GOAI/s10-field-assistant` | 当前已汇总的开发仓库，优先从这里读代码 |
| `REAL` | `<home>/Documents/ChatGPT/GOAI/s10-real-readiness` | 原生接入原工作目录、历史实机证据 |
| `V3` | `<home>/Documents/ChatGPT/GOAI/map-reviews/0914_fr_v3-20260914-142008` | v3 原始地图、审计、建模与实验 |
| `BAG` | `<home>/Documents/ChatGPT/GOAI/recordings/slam_test_20260917_170443` | 9 月 17 日原始录制，含完整 MCAP |
...
手机入口：连 `<ROBOT_WIFI_SSID>`，访问 `http://10.21.41.1:8080/`。已有代理将热点入口转到 102 的 `10.21.33.102:8080`。地址用于现有部署说明，本次未在线刷新。
