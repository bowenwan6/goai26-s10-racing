...
| 手机采集与 Wi-Fi | AGX Wi-Fi 用于连接外网；保留 `s10-agx-internet.service`，尚未部署手机采集站 | `/home/ysc/s10_capture_session` 与 `s10-capture-session.service`；独立热点 `S10-Capture-050`，网页 `10.42.50.1:8091` |
