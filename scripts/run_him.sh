...
python3 "$REPO_ROOT/scripts/patch_him_upstream.py" --check
S10_INSTALL_BASE="${S10_INSTALL_BASE:-$REPO_ROOT/install}"
python3 "$REPO_ROOT/scripts/runtime_fingerprint.py" check --install-base "$S10_INSTALL_BASE" --controller him
set +u
