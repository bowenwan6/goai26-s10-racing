...
from s10_control_gui import ACTIONS

MODELS = {
    'Turn Stop 2000 (research)': '/home/golai/s10-sdk-isolated-ptzjbjrx',
    'Stairs - retained_round1_best': '/home/golai/s10-sdk-isolated-j50b2mzi',
    'M20 Native1000 (research)': '/home/golai/s10-sdk-isolated-l07kue1l',
    'speedturn2000': '/home/golai/s10-sdk-isolated-xly21vwi',
}


def gui():
    model_name = os.environ.get('S10_MODEL_NAME', 'speedturn2000')
    models = dict(MODELS)
    models[model_name] = os.environ.get('S10_SDK_TRIAL_ROOT') or models.get(model_name, MODELS['speedturn2000'])
    handset = os.environ.get('S10_CONTROL_SOURCE') == 'handset'
    root = tk.Tk()
    ...
    packet = {'action': 'zero'}
    motion_buttons = {}
    speed = tk.StringVar(value='100' if handset else '20')
    ...
    if '--ui-check' in sys.argv:
        ...
        if handset:
            ...
            assert packet == {'action': 'handset', 'limit': 1., 'enabled': True}
            move('forward')
