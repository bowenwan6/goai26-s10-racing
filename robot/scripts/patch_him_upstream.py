...
HEADERS = (
    (ROOT / 'robot/integration/ros_cmd_interface.hpp', 'interface/user_command/ros_cmd_interface.hpp'),
    (ROOT / 'robot/integration/s10_policy_runner.hpp', 'run_policy/s10_policy_runner.hpp'),
    (ROOT / 'robot/integration/rl_control_state.hpp', 'state_machine/quadruped_wheel/rl_control_state.hpp'),
    (ROOT / 'robot/integration/standup_state.hpp', 'state_machine/quadruped_wheel/standup_state.hpp'),
)
